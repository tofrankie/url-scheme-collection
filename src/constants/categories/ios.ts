...
const IOS: UrlSchemeWithoutCategory[] = [
  ...
  },
  {
    ...
    contributors: ['toFrankie'],
    updatedAt: '2025-08-09T00:00:00Z',
    urlTemplate: 'itms-apps://search.itunes.apple.com/WebObjects/MZSearch.woa/wa/search?media=software&term=<keyword>',
    slots: [
      {
        name: 'keyword',
        description: '搜索关键词',
    ...
    examples: ['itms-apps://search.itunes.apple.com/WebObjects/MZSearch.woa/wa/search?media=software&term=<keyword>'],
  },
  {
